<footer>
	<div>
	<script type="text/javascript" charset="utf-8" src=<?php echo $PATH . "/js/DataTables/media/js/jquery.js"; ?>></script>
	<script type="text/javascript" charset="utf-8" src=<?php echo $PATH . "/js/DataTables/media/js/jquery.dataTables.js"; ?>></script>
